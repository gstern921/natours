...
exports.showErrorAlert = exports.showSuccessAlert = exports.hideAlert = void 0;
...
var showAlert = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(type, msg) {
    var duration,
        alertEl,
        message,
        _args = arguments;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            duration = _args.length > 2 && _args[2] !== undefined ? _args[2] : 5;
            hideAlert();
            alertEl = document.createElement('div');
            message = document.createTextNode(msg);
            alertEl.classList.add('alert', "alert--".concat(type));
...
var showSuccessAlert = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            duration = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : 5;
            _context2.next = 3;
            return showAlert('success', msg, duration);
  ...
  return function showSuccessAlert(_x3) {
...
var showErrorAlert = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            duration = _args3.length > 1 && _args3[1] !== undefined ? _args3[1] : 5;
            _context3.next = 3;
            return showAlert('error', msg, duration);
  ...
  return function showErrorAlert(_x4) {
...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, password, token) {
    var data, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showSuccessAlert)('Sign in successful');
              setTimeout(function () {
          ...
          case 8:
            ...
            (0, _alerts.showErrorAlert)(_context.t0.response.data.message);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showSuccessAlert)('Sign out successful');
              setTimeout(function () {
                return location.assign('/');
              }, 1500);
            }
          ...
          case 7:
            ...
            (0, _alerts.showErrorAlert)('Sign out unsuccessful');
...
var _default = logout;
exports.default = _default;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateMyAccountSettings.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateMyPassword = exports.updateMyAccountSettings = void 0;
...
var updateMyAccountSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, token) {
    var response;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 6;
            return (0, _alerts.showSuccessAlert)('Account data updated successfully!');
  ...
  return function updateMyAccountSettings(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateMyAccountSettings = updateMyAccountSettings;

var updateMyPassword = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_ref2, token) {
    var currentPassword, password, passwordConfirm, response;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            currentPassword = _ref2.currentPassword, password = _ref2.password, passwordConfirm = _ref2.passwordConfirm;
            _context2.prev = 1;
            _context2.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
          ...
          case 4:
            ...
            (0, _alerts.showSuccessAlert)('Account password updated successfully!');
            _context2.next = 11;
            break;
          ...
          case 8:
            ...
            (0, _alerts.showErrorAlert)(_context2.t0.response.data.message);
  ...
  return function updateMyPassword(_x3, _x4) {
    return _ref3.apply(this, arguments);
  };
}();
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZ2NydW5rIiwiYSI6ImNrZ3JpMTk3czBxbGcyc2xxampxeG4wbW4ifQ.lO3skggQVY3ifmku0KlTWQ';
  var geojson = {
  ...
  locations.forEach(function (marker) {
    ...
    new mapboxgl.Popup({
      offset: 30,
      closeOnClick: false
    }).setLngLat(marker.coordinates).setHTML('<p>' + marker.description + '</p>').addTo(map);
...
var stripe = typeof Stripe === 'function' ? Stripe('pk_test_51HleaYFH5t3NAX027SUhUHrw2sNLSOedAdAwu6J7dHrsYiUJstbTctWv1zSF9cGbwgLcizknxoEsFcSN7PYmAGi200RLWYi2v6') : null;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showErrorAlert)(_context.t0.message);
...
var _updateMyAccountSettings = require("./updateMyAccountSettings");
...
var changeMyAccountSettingsForm = document.getElementById('change-my-account-settings-form');
var changeMyPasswordForm = document.getElementById('change-my-password-form');
var locations = mapBox ? JSON.parse(mapBox.dataset.locations) : null;

if (locations) {
  (0, _mapbox.displayMap)(locations);
}

var csrfMetaElement = document.querySelector('meta[name="csrf-token"]');
var csrfToken = csrfMetaElement ? csrfMetaElement.getAttribute('content') : null;
var alertMessage = document.body.dataset.alertMessage;
alertMessage = alertMessage ? alertMessage.trim() : alertMessage;

if (alertMessage) {
  var characterCount = alertMessage.length;
  var duration = Math.max(characterCount / 7, 5);
  var type = document.body.dataset.alertType;

  if (type === 'error') {
    (0, _alerts.showErrorAlert)(alertMessage, duration);
  } else {
    (0, _alerts.showSuccessAlert)(alertMessage, duration);
  }
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              (0, _login.default)(email, password, csrfToken);
...
if (logoutButton) {
  logoutButton.addEventListener('click', function (e) {
    e.preventDefault();
    (0, _logout.default)(csrfToken);
  });
}

if (changeMyAccountSettingsForm) {
  changeMyAccountSettingsForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 8;
              return (0, _updateMyAccountSettings.updateMyAccountSettings)(formData, csrfToken);
...
if (changeMyPasswordForm) {
  changeMyPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var target, currentPassword, password, passwordConfirm, previousButtonText;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              e.preventDefault();
              target = e.target;
              currentPassword = target.querySelector('#password-current').value;
              password = target.querySelector('#password').value;
              passwordConfirm = target.querySelector('#password-confirm').value;
              previousButtonText = target.querySelector('#change-my-password-button').textContent;
              target.querySelector('#change-my-password-button').textContent = 'UPDATING PASSWORD...';
              target.querySelector('#change-my-password-button').disabled = true;
              _context3.next = 10;
              return (0, _updateMyAccountSettings.updateMyPassword)({
                currentPassword: currentPassword,
                password: password,
                passwordConfirm: passwordConfirm,
                csrfToken: csrfToken
            ...
            case 10:
              ...
              target.querySelector('#change-my-password-button').textContent = previousButtonText;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              tourId = el.dataset.tourId;
              _context4.next = 5;
              return (0, _stripe.bookTour)(tourId, csrfToken);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "53059" + '/');
